    ...
    var startScreen = {
        ...
        _showRules: function(parent) {
            ...
            rules.innerHTML = [
                ...
                '<p>时值盛唐，城中莲花池畔举办一年一度的"莲池竞渡"。五只灵龟（青玄、赤霄、黄枢、白泽、墨渊）在16段莲池赛道上角逐。你与各方宾客通过<strong>下注</strong>和<strong>布囊设局</strong>赢得铜钱，铜钱最多者封号<strong>"莲池伯"</strong>。</p>',
                ...
                '<p><strong>签筒：</strong>每巡（回合）签筒内有5支签（对应5色灵龟），点数1~3。逐支抽出，对应灵龟移动相应步数。5支签抽完该巡结束。</p>',

                '<div style="color:#c04040;font-size:15px;font-weight:bold;margin-top:12px;">叁 · 四种行动</div>',
                '<p>轮到玩家时，从以下行动中任选其一：</p>',
                '<ol>',
                '<li><strong>观莲下注</strong> — 拿取一张回合押注券（每色3张共15张），巡结束时按当前名次结算：第一名得5/3/2文，第二名得1文，其余赔1文。</li>',
                '<li><strong>布囊设局</strong> — 将自己的锦囊放于赛道空格（选浮萍+1或漩涡-1）。不能放在第1格、有龟的格、已有锦囊的相邻格。有龟踩中时，锦囊主人立即得1文。</li>',
                '<li><strong>摇签问路</strong> — 从签筒抽一支签，对应灵龟移动。获得一张签筹，巡结束时每张换1文。稳定收入。</li>',
                ...
                '<div style="color:#c04040;font-size:15px;font-weight:bold;margin-top:12px;">伍 · 胜负判定</div>',
                '<p>任意灵龟抵达第16格"摘莲台"时比赛结束。进行最后一次巡结算后，翻开所有全程竞猜签（鳌头+殿后）结算奖惩。<strong>铜钱最多者</strong>获胜。</p>',
